...
////// Emissive:
                ...
                float3 emissive = (_Gradient_var.r*min((((_Color.rgb-float3(node_4719,node_4719,node_4719))*(1.0 - node_3405))+(node_3405*_Color.rgb)),_Color.rgb)*_Trasparency);
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float node_4719 = 0.3;
                float node_3405 = pow(1.0-max(0,dot(normalDirection, viewDirection)),0.7);
                o.Emission = (_Gradient_var.r*min((((_Color.rgb-float3(node_4719,node_4719,node_4719))*(1.0 - node_3405))+(node_3405*_Color.rgb)),_Color.rgb)*_Trasparency);
