...
///////// Gloss:
                float node_2140 = 0.0;
                float node_8522_if_leA = step(_Trasparency,node_2140);
                float node_8522_if_leB = step(node_2140,_Trasparency);
                float node_8569 = (1.0-_Trasparency);
                float node_6931 = (lerp((node_8522_if_leA*node_8569)+(node_8522_if_leB*node_2140),node_8569,node_8522_if_leA*node_8522_if_leB)*100.0);
